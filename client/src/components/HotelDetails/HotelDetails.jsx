...
const Hotel = () => {
  ...
  return (
    <Paper style={{ padding: '20px', borderRadius: '15px' }} elevation={6}>
      <div className={classes.card}>
        <div className={classes.section}>
          ...
          <Typography gutterBottom variant="body1" component="p">Hotel info {post.message}</Typography>
          ...
          <Divider style={{ margin: '20px 0' }} />
          <Typography gutterBottom variant="body1" component="p"> Average price : {post.price} DH</Typography>
    ...
    >
      ...
      <Rating name="read-only" value={post.stars} readOnly />
...
<Typography variant="h6">
          ...
          <Divider style={{ margin: '20px 0' }} />
          <Typography gutterBottom variant="body1" component="p">{post.stars}</Typography>
